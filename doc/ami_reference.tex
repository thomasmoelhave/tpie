%%
%% $Id: ami_reference.tex,v 1.6 1999-10-25 21:49:14 tavi Exp $
%%
...
\verb|MM_manager|, which has global scope. 
  ...
  % commented out for quick release.
% The following
...
\verb|AMI_SCAN_CONTINUE|\index{AMI_SCAN_*@{\tt AMI\_SCAN\_*}},
...
return \verb|AMI_MERGE_CONTINUE|\index{AMI_MERGE_*@{\tt AMI\_MERGE\_*}}.
...
\verb|AMI_stack<T>|\index{AMI_stack@{\tt AMI\_stack}}, 
which is a subclass of \verb|AMI_STREAM<T>|. In
