%%
%% $Id: implementation.tex,v 1.21 2005-12-19 03:47:02 adanner Exp $
%%
...
\path"include/ami_merge.h"\comment{AD: The ``Darren'' version}
...
The\comment{LA: Add 2x
  sorting somewhere. AD: added in user Reference. Does progress bar stuff also go here or is it
  more general? AD: More general} TPIE sort implementation is a multi-way merge sort.
