...
// File: ami_merge_sorted_runs.h 

#ifndef _AMI_MERGE_SORTED_RUNS_H
#define _AMI_MERGE_SORTED_RUNS_H
// **************************************************************************
// *                                                                        *
// *  This include file contains the routine                                *
// *    ami_merge_sorted_runs                                               *
 ...
 *  'merge_management_object' used by AMI_merge.                   *
    ...
    AMI_STREAM<T> *outStream, CMPR *cmp)
{
  ...
  return ami_merge_sorted_runs(inStreams, arity, outStream, mrgheap);
}
