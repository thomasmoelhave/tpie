...
[![GPL-3.0 License](https://img.shields.io/badge/license-GPL%203.0-blue.svg)](COPYING.md)
...
To compile the entire project and run the unit tests execute following commands.
