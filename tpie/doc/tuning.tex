%%
%% $Id: tuning.tex,v 1.14 2003-11-27 19:53:10 jan Exp $
%%
...
\item[\texttt{--enable-log-lib}]
  ...
  defining \lstinline|TPL_LOGGING| \index{TPL\_LOGGING@{\tt
...
creates a log file\index{log file} in \path"/tmp/TPLOG_XXXXXX", where
