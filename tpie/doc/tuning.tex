%%
%% $Id: tuning.tex,v 1.12 2002-06-25 18:33:49 tavi Exp $
%%
...
%  \index{AMI_IMP_*@{\tt AMI\_IMP\_*}}
  ...
  \myverb{AMI\_stream\_base}, which is the base class of all
  ...
  \myverb{AMI\_stream\_base}. Although this base class has
