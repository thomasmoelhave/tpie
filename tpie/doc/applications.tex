%%
%% $Id: applications.tex,v 1.7 1999-11-17 20:54:54 tavi Exp $
%%
...
\begin{description}
\item[\myverb{-t testsize}]
Set the size of the test to be run to \myverb{testsize}.  Typically this
...
is used.
\item[\myverb{-z randomseed}]
Seed the random number generator with the value \myverb{randomseed}.
