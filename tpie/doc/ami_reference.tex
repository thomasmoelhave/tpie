%%
%% $Id: ami_reference.tex,v 1.20 2005-12-21 16:18:24 jan Exp $
%%
...
\subsection{Public Member Functions}
  ...
  \entry{size\_t \textbf{allocation\_count\_factor}();} { Returns 1 iff
    allocation is switched on. In all other cases, a value of zero is
    returned.} 
...
\comment{LA: Do we care here? AD: means there
are additional public member functions not listed below that we can use} As a
