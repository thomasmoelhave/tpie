%       $Id: errorcodes.tex,v 1.3 1999-10-25 18:04:09 tavi Exp $    
...
\begin{description}\index{AMI_SCAN_*@{\tt AMI\_SCAN\_*}}
\item[{\tt AMI\_SCAN\_CONTINUE}] Tells \verb|AMI_scan()|\index{AMI_scan()@{\tt AMI\_scan()}} to continue
