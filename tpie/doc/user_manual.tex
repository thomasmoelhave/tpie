%%
%% $Id: user_manual.tex,v 1.21 2000-08-08 04:57:52 hutchins Exp $
%%
\chapter{Overview}
...
\section{Installation}\plabel{tut:installation}
\index{installation}
...
%Section~\ref{tut:scanning}), in which case the user does not have to use
%stream operations.
...
\section{Sample Program}\plabel{tut:samplepgm}
...
\verbatiminput{../test/sample_pgm.cpp}

\section{Discussion of Sample Program}\plabel{tut:samplepgm-discuss}
...
\section{Introduction}\plabel{tut:introduction}
...
\section{Basic External Memory Concepts}\plabel{tut:concepts}
...
\section{Streams}\plabel{tut:streams}
...
computational paradigm is contained in an {\em operation management
   object},\index{operation management object}. Operation
...
%be viewed as an implementation of \emph{persistent objects}
...
\emph{Access Method Interface}\index{Access Method Interface
...
\plabel{tut:omos}\index{operation management object}
...
\subsection{ASCII Input/Output} \plabel{tut:ascii-io}
...
\section{Merging} \plabel{tut:merging}
\index{merging|(}
...
\section{Distribution} \plabel{tut:distribution}
\index{Distribution}
...
\subsection{Comparison Sorting} \plabel{tut:cmp-sorting}
...
%(See Section~\ref{tut:bit-permuting}). 
...
\subsection{Merge Sorting} \plabel{tut:mrg-sorting}
\index{sorting!merge|(} 
...
\section{Permutation}\plabel{tut:permutation}
...
\section{Distribution Sweeping} \plabel{tut:distsweep}
