%%
%% $Id: user_manual.tex,v 1.12 1999-07-02 16:30:25 large Exp $
%%
\chapter{Overview}
...
of C++ templates. It currently requires the GNU C++ compiler,
\verb|g++|, version~\gxxversion. We expect that it will also be compatible
