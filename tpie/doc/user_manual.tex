%%
%% $Id: user_manual.tex,v 1.27 2005-11-23 15:14:06 adanner Exp $
%%
\chapter{Overview}
...
TPIE\comment{LA: Jan and Andy please check} has been tested on a
...
\index{license} version 2.\comment{LA: Update} A copy of this license
...
header files in \texttt{tpie\_\version/include}.  You should now have
...
of sort management objects.\comment{LA: We don't have a sort
  management object anymore do we?!}
...
internally by TPIE's merge sort services.\comment{LA: ``services''?
...
parts.\comment{LA: Check that this is correct.}
...
\tobewritten\comment{LA: We need to check if this works correctly AND
  add Queue! Andy?}
