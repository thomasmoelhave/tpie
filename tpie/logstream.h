...
TPIE_PUBLIC void add_log_target(log_target * t);
TPIE_PUBLIC void remove_log_target(log_target * t);

TPIE_PUBLIC void begin_log_group(const std::string & name);
TPIE_PUBLIC void end_log_group();
