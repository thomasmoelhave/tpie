...
private:
	...
	///////////////////////////////////////////////////////////////////////////
	/// \brief Reference to `this` as the CRTP class `CT`.
	///////////////////////////////////////////////////////////////////////////
	CT & self()
	{ return *reinterpret_cast<CT*>(this); }

public:
	///////////////////////////////////////////////////////////////////////////
	const CT & self() const
	{ return *reinterpret_cast<const CT*>(this); }
	...
	///////////////////////////////////////////////////////////////////////////
	difference_type operator-(const CT & o) const
	{ return forward ? (self().index() - o.index()) : (o.index() - self().index()); }
...
///////////////////////////////////////////////////////////////////////////////
/// \brief An array storing elements of type T using B bits to store an element.
///
/// \tparam T The type of elements to store in the array. This has to be `bool`
///           or `int`.
///
/// \tparam B The number of bits used to store a single element. This value must
///           divide the word size, so it can in reality only be 1, 2, or 4.
///////////////////////////////////////////////////////////////////////////////
template <typename T, int B>
class packed_array
	: public linear_memory_base<packed_array<T, B> >
{
public:
	typedef size_t storage_type;

private:
	// TODO: is this necessary? Can we slack this requirement to store more?
	...
	/// \internal
	///
	/// \brief Iterator and reverse iterator will return an element of this
	/// type, it can be cast to a T, and assigned a T value
	///////////////////////////////////////////////////////////////////////////
	...
	private:
		...
		iter_return_type(storage_type * e, size_t i)
			: elms(e), index(i)
			{ }
	public:
		///////////////////////////////////////////////////////////////////////
	...
	template <bool forward>
	class iter_base
		: public packed_array_iter_facade<iter_base<forward>, forward, iter_return_type>
	{
	private:
		...
		///////////////////////////////////////////////////////////////////////
		iter_base(storage_type * elms, size_t index)
			: elm(elms, index)
		{ }
	...
	/// \internal
	///
	/// \brief Base class for const iterator and const reverse iterator
	///
	/// \tparam forward Is this a forward iterator?
	///////////////////////////////////////////////////////////////////////////
	template <bool forward>
	class const_iter_base
		: public packed_array_iter_facade<const_iter_base<forward>, forward, vssucks>
	{
	private:
		friend class packed_array;
		...
		///////////////////////////////////////////////////////////////////////
		const_iter_base(const storage_type * e, size_t i)
			: elms(e), idx(i)
		{ }
	...
	public:
		...
		///////////////////////////////////////////////////////////////////////
		const_iter_base(const_iter_base const& o)
			: elms(o.elms), idx(o.idx)
		{ }

		///////////////////////////////////////////////////////////////////////
		const_iter_base(iter_base<forward> const& o)
			: elms(o.elm.elms), idx(o.elm.index)
	    { }
	};
	...
	/// \internal
	///
	/// \brief Type of values returned by the [] operator.
	///
	/// \details It can be cast to a T, and assigned a T value. That is, this
	/// abstracts away packing and unpacking of logical values into and out of
	/// the physical value that stores them.
	///////////////////////////////////////////////////////////////////////////
	struct return_type
	{
	private:
		...
		///////////////////////////////////////////////////////////////////////
		return_type(storage_type * p_, size_t i_)
			: p(p_), i(i_)
		{ }
...
public:
	...
	///
	/// \details The elements have undefined values
	///
	...
	///
	/// All elements are lost, after resize the value of the entries is
	/// undefined.
	///
	...
	///
	/// \internal We use m_elements -1 as basis for the reverse operators To
	// make sure that the index of rend is positive
	///////////////////////////////////////////////////////////////////////////
	reverse_iterator rbegin()
	{ return reverse_iterator(m_elements-1, perword()+m_size-1); }
	...
	{ return const_reverse_iterator(m_elements-1, perword()+m_size-1); }

	///////////////////////////////////////////////////////////////////////////
	/// \brief Return a reverse iterator to the end of the array
	///
	/// \return a const reverse iterator to the end of the array
	///////////////////////////////////////////////////////////////////////////
	reverse_iterator rend()
	{ return reverse_iterator(m_elements-1, perword()-1); }
	...
	{ return const_reverse_iterator(m_elements-1, perword()-1); }
