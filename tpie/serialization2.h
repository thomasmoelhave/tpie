...
///////////////////////////////////////////////////////////////////////////////
/// \brief tpie::serialize for std::pair.
///////////////////////////////////////////////////////////////////////////////
template <typename D, typename T1, typename T2>
void serialize(D & dst, const std::pair<T1, T2> & p) {
	using tpie::serialize;
	serialize(dst, p.first);
	serialize(dst, p.second);
}

///////////////////////////////////////////////////////////////////////////////
/// \brief tpie::unserialize for std::pair.
///////////////////////////////////////////////////////////////////////////////
template <typename S, typename T1, typename T2>
void unserialize(S & src, std::pair<T1, T2> & p) {
	using tpie::unserialize;
	unserialize(src, p.first);
	unserialize(src, p.second);
}
