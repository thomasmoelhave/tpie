...
tpie_062702/doc by the unzip/tar step below.  The manual includes
...
Place "tpie_062702.tgz" in the directory in which TPIE is to be
installed, "cd" into that directory, and execute the command

   tar xzf tpie_062702.tgz

or 

   gunzip -c tpie_062702.tgz | tar xvf -  

This will produce a directory "tpie_062702" with subdirectories
"doc", "include", "lib", "lib/src", and "test".  Enter the directory
"tpie_062702".  You must now configure TPIE for your particular
...
run-time library "tpie_062702/lib/libtpie.a", the test and sample
programs in directory "tpie_062702/test", and certain header files in
"tpie_062702/include".
...
The manual for TPIE will be created as file "tpie.ps" in the directory
tpie_062702/doc by the unzip/tar step above. It is also available
...
#	$Id: README.txt,v 1.4 2002-06-27 00:38:43 tavi Exp $	
